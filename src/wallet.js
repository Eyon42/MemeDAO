...
export const provider = new ethers.providers.Web3Provider(window.ethereum);//, ...allowedNetworks);
...
export const reactionsModule = new ethers.Contract(addresses['ReactionsModule'], reactionsModuleData.abi, provider);
export const profileHolder = new ethers.Contract(addresses['ProfileHolder'], profileHolderData.abi, provider);
